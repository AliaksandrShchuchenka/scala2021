...
object HW {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(findManagerName("Steve"))
    println(findManagerName("Mark"))
    println(findManagerName("Igor"))
    println(findManagerName("Christy"))
    println(findManagerName("Naveen"))
    println(findManagerName("Megan"))
